  ...
  const testCases: { input: string; parsed: ParsedCrop; applied: sharp.Sharp }[] = [
    {
      ...
      parsed: {
        ...
        ox: { origin: "l", value: 50, unit: "p" },
        oy: { origin: "t", value: 50, unit: "p" },
        options: {},
      },
      applied: {
        extract: {
    ...
    {
      input: "10p,10p,10p,10p",
      parsed: {
        ax: { origin: "l", value: 10, unit: "p" },
        ay: { origin: "t", value: 10, unit: "p" },
        bx: { origin: "r", value: 10, unit: "p" },
        by: { origin: "b", value: 10, unit: "p" },
        ox: { origin: "l", value: 50, unit: "p" },
        oy: { origin: "t", value: 50, unit: "p" },
        options: {},
      },
